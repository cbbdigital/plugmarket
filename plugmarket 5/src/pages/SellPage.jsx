...
// ── Data ──
const MAKES_DATA = {
  Audi: ["A6 e-tron", "A6 Avant e-tron", "e-tron GT", "Q4 e-tron", "Q4 Sportback e-tron", "Q6 e-tron", "Q6 Sportback e-tron", "Q8 e-tron", "Q8 Sportback e-tron", "RS e-tron GT"],
  BMW: ["i3", "i4", "i5", "i5 Touring", "i7", "iX", "iX1", "iX2", "iX3"],
  BYD: ["Atto 2", "Atto 3", "Dolphin", "Han", "Seal", "Seal U", "Sealion 6", "Sealion 7", "Seagull", "Tang"],
  Chevrolet: ["Equinox EV"],
  Citroen: ["ë-C3", "ë-C4", "ë-C4 X", "ë-Berlingo", "ë-SpaceTourer"],
  Cupra: ["Born", "Raval", "Tavascan"],
  Dacia: ["Spring"],
  Fiat: ["500e", "600e", "Grande Panda"],
  Ford: ["Explorer Electric", "Mustang Mach-E", "Puma Gen-E"],
  Genesis: ["GV60", "GV70 Electric", "GV80 Coupe Electric", "G80 Electric"],
  Honda: ["e", "e:Ny1", "Prologue"],
  Hyundai: ["Casper Electric", "Inster", "Ioniq 5", "Ioniq 5 N", "Ioniq 6", "Ioniq 9", "Kona Electric"],
  Jaguar: ["I-Pace", "EV saloon"],
  Jeep: ["Avenger Electric", "Wagoneer S"],
  Kia: ["EV2", "EV3", "EV4", "EV5", "EV6", "EV6 GT", "EV9", "Niro EV"],
  Leapmotor: ["B10", "C10", "T03"],
  Lexus: ["RZ 300e", "RZ 450e", "UX 300e"],
  Lotus: ["Emeya", "Eletre"],
  Lucid: ["Air", "Gravity"],
  Mercedes: ["CLA Electric", "EQA", "EQB", "EQE", "EQE SUV", "EQS", "EQS SUV", "G 580 EQ"],
  MG: ["Cyberster", "MG4", "MG5", "MG7 EV", "MG9 EV", "ZS EV"],
  Mini: ["Aceman E", "Cooper SE", "Countryman E"],
  NIO: ["EL6", "EL7", "EL8", "ES6", "ES7", "ES8", "ET5", "ET5 Touring", "ET7"],
  Nissan: ["Ariya", "Leaf"],
  Omoda: ["E5"],
  Opel: ["Astra Electric", "Corsa Electric", "Frontera Electric", "Grandland Electric", "Mokka Electric", "Vivaro-e"],
  Peugeot: ["e-2008", "e-208", "e-3008", "e-5008", "e-308", "e-408", "e-Rifter"],
  ...
  Toyota: ["bZ3", "bZ4X", "C-HR+", "Urban Cruiser"],
  Volkswagen: ["ID.2", "ID.3", "ID.4", "ID.5", "ID.7", "ID.7 Tourer", "ID.Buzz", "ID.Buzz Cargo"],
  Volvo: ["EC40", "EX30", "EX40", "EX90"],
  Xpeng: ["G6", "G9", "P5", "P7", "X9"],
  Zeekr: ["001", "7 GT", "7X", "009", "X"],
  Other: ["Other"],
};
const COUNTRIES = [
