...
export const EV_DB = [
  ...
  // ═══════════════ ADDED: AFFORDABLE & CHINESE EVs ═══════════════
  {
    make:"Citroën",model:"ë-C3",variant:"You",
    price:"from €23,300",pn:23300,
    wltp:320,range_summer:265,range_winter:195,range_highway:215,
    battery:44,usable:42,dc_peak:100,dc_avg:65,
    charge_5_80_min:27,charge_10_80_min:24,
    consumption_avg:15.5,consumption_highway:18.5,
    seats:5,cargo_liters:310,segment:"city",use:"commute",body:"hatchback",drivetrain:"FWD",
    accel_0_100:11.0,
    tags:["Affordable","Comfortable"],
    strengths:["One of the cheapest 5-seat EVs","Comfortable ride","Usable everyday range","Real 5 seats"],
    weaknesses:["Modest performance","Average highway efficiency","Basic interior materials"],
    trip_score:4,city_score:9,value_score:10,
    img:FB,
  },
  {
    make:"Hyundai",model:"Inster",variant:"Long Range",
    price:"from €24,000",pn:24000,
    wltp:370,range_summer:310,range_winter:230,range_highway:250,
    battery:49,usable:46,dc_peak:85,dc_avg:60,
    charge_5_80_min:31,charge_10_80_min:28,
    consumption_avg:15,consumption_highway:18,
    seats:4,cargo_liters:280,segment:"city",use:"city",body:"hatchback",drivetrain:"FWD",
    accel_0_100:10.6,
    tags:["City car","Clever space"],
    strengths:["Surprising interior space","Good real-world range for a city car","Sliding rear seats","Cheap to run"],
    weaknesses:["4 seats only","Slow-ish DC charging","Small boot"],
    trip_score:3,city_score:10,value_score:9,
    img:FB,
  },
  {
    make:"Leapmotor",model:"T03",variant:"Comfort",
    price:"from €18,900",pn:18900,
    wltp:265,range_summer:215,range_winter:155,range_highway:165,
    battery:37.3,usable:36,dc_peak:48,dc_avg:36,
    charge_5_80_min:36,charge_10_80_min:32,
    consumption_avg:14,consumption_highway:17,
    seats:4,cargo_liters:210,segment:"city",use:"city",body:"hatchback",drivetrain:"FWD",
    accel_0_100:12.7,
    tags:["Ultra-cheap","City runabout"],
    strengths:["Among the cheapest EVs in Europe","Well-equipped for the price","Easy to park"],
    weaknesses:["Slow DC charging","Not for highways","Small boot"],
    trip_score:2,city_score:9,value_score:10,
    img:FB,
  },
  {
    make:"Leapmotor",model:"C10",variant:"Design",
    price:"from €36,400",pn:36400,
    wltp:420,range_summer:350,range_winter:260,range_highway:280,
    battery:69.9,usable:67,dc_peak:150,dc_avg:90,
    charge_5_80_min:30,charge_10_80_min:27,
    consumption_avg:18,consumption_highway:21.5,
    seats:5,cargo_liters:435,segment:"suv",use:"commute",body:"suv",drivetrain:"RWD",
    accel_0_100:7.5,
    tags:["Value SUV","Spacious"],
    strengths:["Big family SUV at a low price","Generous equipment","Comfortable cabin"],
    weaknesses:["Higher consumption","Software still maturing","Average efficiency"],
    trip_score:5,city_score:6,value_score:9,
    img:FB,
  },
  {
    make:"BYD",model:"Dolphin Surf",variant:"Comfort",
    price:"from €19,990",pn:19990,
    wltp:322,range_summer:265,range_winter:195,range_highway:210,
    battery:43.2,usable:41,dc_peak:85,dc_avg:55,
    charge_5_80_min:30,charge_10_80_min:27,
    consumption_avg:14.5,consumption_highway:17.5,
    seats:5,cargo_liters:308,segment:"city",use:"commute",body:"hatchback",drivetrain:"FWD",
    accel_0_100:9.1,
    tags:["Budget star","5 seats"],
    strengths:["Very cheap for a 5-seater","Decent real range","Blade battery safety","Well equipped"],
    weaknesses:["Firm ride","Average highway efficiency","Modest charging speed"],
    trip_score:4,city_score:9,value_score:10,
    img:FB,
  },
  {
    make:"Kia",model:"EV3",variant:"Long Range",
    price:"from €35,990",pn:35990,
    wltp:605,range_summer:490,range_winter:360,range_highway:390,
    battery:81.4,usable:78,dc_peak:128,dc_avg:85,
    charge_5_80_min:31,charge_10_80_min:29,
    consumption_avg:15,consumption_highway:18,
    seats:5,cargo_liters:460,segment:"suv",use:"allround",body:"suv",drivetrain:"FWD",
    accel_0_100:7.5,
    tags:["Big range","Family SUV"],
    strengths:["Over 600km WLTP for the money","Spacious and practical","Efficient","Great interior"],
    weaknesses:["DC charging only average","FWD can struggle on power","Wind noise at speed"],
    trip_score:6,city_score:7,value_score:9,
    img:FB,
  },
  {
    make:"Renault",model:"4 E-Tech",variant:"Comfort Range",
    price:"from €30,000",pn:30000,
    wltp:410,range_summer:340,range_winter:250,range_highway:270,
    battery:52,usable:50,dc_peak:100,dc_avg:70,
    charge_5_80_min:32,charge_10_80_min:29,
    consumption_avg:15.5,consumption_highway:18.5,
    seats:5,cargo_liters:420,segment:"compact",use:"commute",body:"suv",drivetrain:"FWD",
    accel_0_100:8.2,
    tags:["Retro crossover","Practical"],
    strengths:["Characterful design","Practical small SUV","Good city + commute range","Comfortable"],
    weaknesses:["Not a long-distance car","Average charging","Modest performance"],
    trip_score:5,city_score:8,value_score:8,
    img:FB,
  },
  {
    make:"Nissan",model:"Leaf",variant:"e+ (2025)",
    price:"from €31,000",pn:31000,
    wltp:430,range_summer:355,range_winter:265,range_highway:285,
    battery:62,usable:59,dc_peak:105,dc_avg:70,
    charge_5_80_min:35,charge_10_80_min:31,
    consumption_avg:16,consumption_highway:19,
    seats:5,cargo_liters:435,segment:"compact",use:"commute",body:"hatchback",drivetrain:"FWD",
    accel_0_100:7.9,
    tags:["Proven","Everyday"],
    strengths:["Reliable, well-proven platform","Comfortable family hatch","Now uses CCS charging"],
    weaknesses:["Efficiency behind newest rivals","Not a road-trip champion"],
    trip_score:5,city_score:7,value_score:8,
    img:FB,
  },
  {
    make:"MG",model:"MG4 (LFP)",variant:"Standard",
    price:"from €27,990",pn:27990,
    wltp:350,range_summer:290,range_winter:215,range_highway:235,
    battery:51,usable:49,dc_peak:120,dc_avg:80,
    charge_5_80_min:26,charge_10_80_min:24,
    consumption_avg:15.5,consumption_highway:18.5,
    seats:5,cargo_liters:363,segment:"compact",use:"commute",body:"hatchback",drivetrain:"RWD",
    accel_0_100:8.0,
    tags:["Value hatch","RWD fun"],
    strengths:["Great value","Rear-wheel-drive handling","Decent charging","Practical"],
    weaknesses:["Interior plastics","Infotainment fiddly","Standard battery range modest"],
    trip_score:5,city_score:8,value_score:9,
    img:FB,
  },
  {
    make:"Xpeng",model:"G6",variant:"Long Range",
    price:"from €43,600",pn:43600,
    wltp:570,range_summer:465,range_winter:345,range_highway:375,
    battery:87.5,usable:83,dc_peak:280,dc_avg:165,
    charge_5_80_min:20,charge_10_80_min:18,
    consumption_avg:17,consumption_highway:20,
    seats:5,cargo_liters:571,segment:"suv",use:"allround",body:"suv",drivetrain:"RWD",
    accel_0_100:6.7,
    tags:["800V","Fast charging"],
    strengths:["800V ultra-fast charging","Long range","Lots of tech","Spacious"],
    weaknesses:["Brand service network still growing","Software learning curve"],
    trip_score:8,city_score:6,value_score:8,
    img:FB,
  },
  {
    make:"Zeekr",model:"X",variant:"Long Range",
    price:"from €44,990",pn:44990,
    wltp:440,range_summer:360,range_winter:270,range_highway:290,
    battery:66,usable:64,dc_peak:150,dc_avg:100,
    charge_5_80_min:30,charge_10_80_min:27,
    consumption_avg:17,consumption_highway:20.5,
    seats:5,cargo_liters:362,segment:"suv",use:"commute",body:"suv",drivetrain:"RWD",
    accel_0_100:5.9,
    tags:["Premium feel","Quick"],
    strengths:["Upmarket interior","Quick and refined","Well built"],
    weaknesses:["Range average for price","Newer brand in Europe"],
    trip_score:6,city_score:7,value_score:7,
    img:FB,
  },
  {
    make:"BYD",model:"Atto 2",variant:"Comfort",
    price:"from €29,990",pn:29990,
    wltp:312,range_summer:255,range_winter:190,range_highway:205,
    battery:45.1,usable:43,dc_peak:65,dc_avg:48,
    charge_5_80_min:37,charge_10_80_min:33,
    consumption_avg:16,consumption_highway:19,
    seats:5,cargo_liters:400,segment:"suv",use:"commute",body:"suv",drivetrain:"FWD",
    accel_0_100:7.9,
    tags:["Small SUV","Affordable"],
    strengths:["Affordable compact SUV","Blade battery safety","Practical for city + suburbs"],
    weaknesses:["Slow DC charging","Range modest","Not for frequent long trips"],
    trip_score:3,city_score:8,value_score:8,
    img:FB,
  },
  {
    make:"NIO",model:"ET5",variant:"75 kWh",
    price:"from €49,900",pn:49900,
    wltp:455,range_summer:375,range_winter:280,range_highway:300,
    battery:75,usable:71,dc_peak:140,dc_avg:95,
    charge_5_80_min:30,charge_10_80_min:27,
    consumption_avg:17.5,consumption_highway:21,
    seats:5,cargo_liters:386,segment:"sedan",use:"allround",body:"sedan",drivetrain:"AWD",
    accel_0_100:4.0,
    tags:["Battery swap","Sporty"],
    strengths:["Battery-swap option (fast top-ups)","Very quick","Premium interior","AWD"],
    weaknesses:["Swap network limited in Europe","Higher consumption","Depreciation unknown"],
    trip_score:6,city_score:6,value_score:6,
    img:FB,
  },
];
